...
User.prototype.validate = function() {
   ...
   if(this.data.username.length > 0 && this.data.username.length < 12) {this.errors.push("Username must have atleast 12 charaters!")}
   if(this.data.username.length > 100) {this.errors.push("Username can not exceed more than 100 charaters!")}
}
